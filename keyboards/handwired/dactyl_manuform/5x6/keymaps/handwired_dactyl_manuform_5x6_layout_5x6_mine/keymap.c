...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_5x6(
            ...
            KC_LSFT, KC_Z, KC_X, KC_M, KC_C, KC_V,                                    KC_K, KC_L, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                           KC_LEFT, KC_RGHT,                                                      KC_UP, KC_DOWN,
                                  LT(1,KC_BSPC), LT(2,KC_DEL),                      LT(2,KC_ENT), LT(1,KC_SPC),

                                         KC_LALT, TO(3),                     TO(3), KC_RALT,
                                         LT(2,KC_HOME),LT(3,KC_END),         LT(3, KC_LGUI), LT(2,KC_GRV)),
	...
	[1] = LAYOUT_5x6(
            ...
            KC_PPLS, KC_MINS, KC_P7, KC_P8, KC_P9, KC_LPRN,                          KC_RPRN, KC_P7, KC_P8, KC_P9, KC_MINS, KC_PPLS,
            LALT_T(KC_TAB), KC_EQL, KC_P4, KC_P5, KC_P6, LSFT(KC_LBRC),                RSFT(KC_RBRC), KC_P4, KC_P5, KC_P6, KC_EQL, RCTL_T(KC_BSLS),
            KC_UNDS, KC_TRNS, KC_P1, KC_P2, KC_P3, KC_LBRC,                          KC_RBRC, KC_P1, KC_P2, KC_P3, KC_TRNS, KC_UNDS,
                              KC_TRNS, KC_TRNS,                                                       KC_TRNS, KC_TRNS,
                                         KC_P0,KC_TRNS,                              KC_TRNS, KC_P0,
	...
	[2] = LAYOUT_5x6(
            ...
            KC_LCTL, KC_UP, KC_DOWN, KC_LEFT, KC_RGHT, KC_TRNS,                 RSFT(KC_RBRC), KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, KC_VOLU,
